      ...
      <section className="border-b hairline">
        <div className="mx-auto max-w-[1440px] px-4 pt-14 pb-6 md:px-8 md:pt-20">
          <div className="mono-label mb-3 text-accent">
            Editorial deals · Updated Fridays
          </div>
          ...
          <p className="mt-4 max-w-[720px] text-[16px] leading-[1.55] text-ink-soft md:text-[18px]">
            Positioning plays, partner awards that price 40% below the obvious
            choice, and routes most searches never surface. Your saved wallet
            from the app is used to flag which deals you can redeem.
          </p>
        </div>
      </section>
